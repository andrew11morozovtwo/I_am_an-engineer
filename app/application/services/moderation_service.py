...
RUSSIAN_PROFANITY_PATTERNS: Dict[str, Pattern] = {
    ...
    "гандон": re.compile(r'[гg][аa@][нn][дd][оo0][нn]', re.IGNORECASE),
    ...
    "бля": re.compile(r'[бb6][лl][яя]', re.IGNORECASE),
    "хуй": re.compile(r'[хx][уy][йy]', re.IGNORECASE),
    "хуйня": re.compile(r'[хx][уy][йy][нn][яя]', re.IGNORECASE),
    "пизда": re.compile(r'[пp][иi1l][зz3][дd][аa@]', re.IGNORECASE),
    ...
    "жопа": re.compile(r'[жz][оo0][пp][аa@]', re.IGNORECASE),
}
